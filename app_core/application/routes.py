...
def view_charachter_creator():
    ...
    if(request.method == 'POST') and (form.validate_on_submit()):
        ...
        int(rating)
        charachter = Charachter(first_name=first_name,second_name=second_name,race_id=int(race_num),weapon_id=int(weapon_num),role_id=int(role_num),rating=int(rating))
